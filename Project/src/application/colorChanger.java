...
public class colorChanger extends obstacle1 {
	private double coordinateX;
	private double coordinateY;
	public ImageView logo=new ImageView("imageSource/colorChanger.png");
	int z=0;
	public colorChanger(AnchorPane main, int x, int y){
		setCoordinateX(x);
		setCoordinateY(y);
		logo.setX(30);
	      logo.setY(30);
	...
	public int collide(ball b1) {
		int y=0;
		if(b1.getCoordinateY()>=getCoordinateY()-1.75 && b1.getCoordinateY()<=getCoordinateY()+1.75 && y==z){
			return 1;
		}
